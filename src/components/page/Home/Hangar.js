...
function Hangar() {
    ...
    <>
       <header id="header" class="header d-flex align-items-center">
        ...
        <div class="breadcrumbs d-flex align-items-center" style={{ backgroundImage: `url(assets/img/hangar-fond.jpg)`}}>
            <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

            <h2>Projet réhabilitation hangar et aménagement pharmaceutique socafi pharma 2</h2>
            <ol>
